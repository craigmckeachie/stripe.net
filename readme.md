...
[![Stripe API and Stripe.NET Versions](http://i.imgur.com/eArdtRE.png?1)](https://youtu.be/c6dJRc9V_Ls?t=51s&related=0 "Stripe API and Stripe.NET Versions"){:target="_blank"}
